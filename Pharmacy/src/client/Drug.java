...
public class Drug implements ActionListener
{

        JFrame drugFrame;
        JLabel drugName_,drugCode_,productionCompanyName_,productionDate_,expirationDate_,drugType_,drugQuantity_,hint,stripes_,drugPrice,search;
        JTextField drugName,drugCode,productionCompanyName,drugQuantity,stripes,jprice,jsearch;
        JComboBox drugType;
        ...
        public void display()
        {
            ...
            hint=new JLabel("If not Tablets put No. Stripes = 1 ");
            hint.setSize(400, 30);
            hint.setLocation(700,420);
            hint.setFont(new Font("Sans Serif", 0, 18));
            ...
            drugPrice=new JLabel("Package price");
        ...
        public void actionPerformed(ActionEvent source) 
    {
          ...
          else if(clickedButton==delete)  
        {
            ...
            else
          {
            ...
            {
                ShowAllDrugs obj=new ShowAllDrugs();
                obj.displayAllDrugs();
            }
          else
        {
        ...
        public int autoIncrementId() throws SQLException {
            ...
            PreparedStatement ps1=conn.prepareStatement("select id from drug");
        ...
        public void addNewDrug() throws SQLException {
             ...
             */
            Connection conn=Database.getConnection();
            PreparedStatement ps=conn.prepareStatement("insert into drug (id,code,name,type,numberofstripes,productioncompany," +
                "quantity,price,expirationdate,productiondate) values(?,?,?,?,?,?,?,?,?,?)");
            ...
            ps.setInt(7, Integer.parseInt(drugQuantity.getText()));
            ps.setInt(8, Integer.parseInt(jprice.getText()));
            ps.setString(9, expirationDate.getText());
            ps.setString(10, productionDate.getText());         
            ps.executeUpdate();
            conn.commit();
            conn.close();
        }
        public void displaySpecificDrug() throws SQLException {
            ...
            PreparedStatement ps=conn.prepareStatement("select * from drug where name=? or code=?");
        ...
        public void removeSpecificDrug() throws SQLException {
             ...
             */
           Connection conn= Database.getConnection();
           PreparedStatement ps=conn.prepareStatement("delete from drug where name=?");
           ps.setString(1, jsearch.getText());
           ps.executeUpdate();
           conn.commit();
           conn.close();
        ...
        public void updateDataase() throws SQLException {
             ...
             */
            Connection conn=Database.getConnection();
            PreparedStatement ps=conn.prepareStatement("update drug set name=?,type=?,numberofstripes=?" +
                ",productioncompany=?,quantity=?,price=? where name=?");
            ...
            ps.setInt(5, Integer.parseInt(drugQuantity.getText()));
            ps.setInt(6, Integer.parseInt(jprice.getText()));
            ps.setString(7, jsearch.getText());
            ps.executeUpdate();
            conn.commit();
            conn.close();
        }
