...
public class ShowALLDrugsInStock extends JFrame implements ActionListener
{
    JButton print;
    JTable table;
    ArrayList<Drugs>allDrugs=new ArrayList<Drugs>(); // to store in it the data which returned from the database

    public ShowALLDrugsInStock() {
        super("All Drugs in The Stock");
    ...
    public void actionPerformed(ActionEvent source) 
    {
        ...
        {
            MessageFormat header=new MessageFormat("All Drugs in The Stock");
    ...
    public void getDrugDataFromDatabase() throws SQLException {
        ...
        PreparedStatement PreparedStatement=conn.prepareStatement("select * from medecinestock order by id");
